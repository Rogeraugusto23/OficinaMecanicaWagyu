...
## Status
**Superseded pelo [ADR-002](./ADR-002-clean-architecture-ordens-servico.md).**
Esta decisão foi revista: o time optou por retomar a migração para Clean
Architecture ainda durante a Fase 2, começando pelo módulo de OrdensServico.
O restante deste documento é mantido como registro histórico do raciocínio
que levou à decisão original.

## Status original (histórico)
Aceito
